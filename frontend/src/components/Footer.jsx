...
const Footer = () => {
  return (
    <div>
        <div className="flex flex-col w-full h-fit bg-[#374151] text-[#e5e7eb] px-14 py-10">
    <div className="flex flex-row">
        <div className="flex flex-col gap-2 justify-center w-[35%]">
            <div className="flex items-center w-full gap-4">
                <img src="../assets/ufo.png" className="h-8" alt="Flowbite Logo" />
                <div className="text-3xl font-bold ">UFO</div>
            </div>
        ...
        <div className="flex flex-row w-[65%] justify-end gap-16 text-nowrap">
            <div className="grid grid-cols-2 gap-9">
                <div className="flex flex-col gap-2">
                    <div className="font-bold uppercase text-[#ffffff] pb-3">UFO</div> <a href="#xxx" className="hover:underline">About Us</a>  <a href="#xxx" className="hover:underline">Contact</a>  <a href="#xxx" className="hover:underline">Support</a>  <a href="#xxx" className="hover:underline">News</a>
